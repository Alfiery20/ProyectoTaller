        ...
        <main id="login" class="form-signin">
            <form method="post" action="TrabajadorServlet?Dato=1">
                ...
                <div class="form-floating">
                    <input type="email" class="form-control m-2" name="corr" id="floatingInput" placeholder="name@example.com">
                    <label for="floatingInput">Correo Electronico</label>
                </div>
                <div class="form-floating">
                    <input type="password" name="cont" class="form-control m-2" id="floatingPassword" placeholder="Password">
