...
<html>
    ...
    <body class="position-relative">
        ...
        <div id="proyectoN" class="col-md-8 order-md-1 w-50">
            <h1 class="mb-3 text-center"><%=Objects.equals(usu.getTipo(), "A") ? "Modificar de " : ""%>Proyecto</h1>
            <hr class="mb-4">
            <form class="needs-validation" novalidate="" method="post" action="ProyectoServlet?Dato=4">
                <div class="mb-3">
                    <label>Nombre del Proyecto</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="username" name="nom" value="<%=prote.getNombre()%>" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "readonly"%>>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="lastName" name="dur" value="<%=prote.getDuracion()%>" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "readonly"%> >
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>Presupuesto</label>
                        <input type="number" class="form-control" id="firstName" name="pre" value="<%=prote.getPresupuesto()%>" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "readonly"%>>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Estado</label>
                        <div class="d-flex" >
                            <div class="custom-control custom-radio m-2">
                                <input name="est" value="P" type="radio" class="custom-control-input" <%=Objects.equals(prote.getEtado(), "P") ? "checked" : ""%> <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                                <label class="custom-control-label" for="credit">Pendiente</label>
                            </div>
                            <div class="custom-control custom-radio m-2">
                                <input name="est" value="E" type="radio" class="custom-control-input" <%=Objects.equals(prote.getEtado(), "E") ? "checked" : ""%> <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                                <label class="custom-control-label" for="debit">En Progreso</label>
                            </div>
                            <div class="custom-control custom-radio m-2">
                                <input name="est" value="T" type="radio" class="custom-control-input" <%=Objects.equals(prote.getEtado(), "T") ? "checked" : ""%> <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="firstName" name="fin" value="<%=prote.getFechaIni()%>" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "readonly"%>>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Fecha Termino</label>
                        <input type="date" class="form-control" id="lastName" name="fet" value="<%=prote.getFechaTer()%>" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "readonly"%>>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex">
                            <div class="custom-control custom-radio m-2">
                                <input id="credit" name="tip" value="D" type="radio" class="custom-control-input" <%=Objects.equals(prote.getTipo(), "D") ? "checked" : ""%> <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                                <label class="custom-control-label" for="credit">Desarollo</label>
                            </div>
                            <div class="custom-control custom-radio m-2">
                                <input id="debit" name="tip" value="S" type="radio" class="custom-control-input" <%=Objects.equals(prote.getTipo(), "S") ? "checked" : ""%> <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <select class="custom-select d-block w-100" id="country" required="" name="cli" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                    ...
                    <div class="mb-5">
                        ...
                        <select class="custom-select d-block w-100 dropdown-menu" id="country" required="" name="tra" <%=Objects.equals(usu.getTipo(), "A") ? "required" : "disabled"%>>
                        ...
                        <table class="table" border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="ModuloServlet?Dato=4&id=<%=modulo.getId()%>" class="btn btn-lg btn-primary"><%=Objects.equals(usu.getTipo(), "A") ? "Editar" : "Observar"%></a>
